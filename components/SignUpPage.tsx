      ...
      <div className="min-h-screen bg-linear-to-b from-emerald-50 via-sky-50 to-[#fdfcf0] flex items-center justify-center p-6 relative overflow-hidden font-[Quicksand]">
        <div className="max-w-md w-full relative z-10 animate-fade-in">
          <div className="ghibli-card p-12 bg-white/90 shadow-xl border border-white text-center space-y-6">
            ...
            <p className="text-stone-500">We've sent a magic link to <span className="font-bold text-stone-700">{formData.email}</span>. Click the link to complete your signup!</p>
        ...
        <div className="ghibli-card p-8 bg-white/90 shadow-xl border border-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              ...
              className="w-full bg-emerald-500 text-white py-3.5 font-bold shadow-lg shadow-emerald-200 hover:bg-emerald-600 hover:shadow-emerald-300 transition-all h-auto mt-4"
            >
